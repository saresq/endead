...
/** `plural(2, 'zombie', 'zombies')` → `'zombies'`. Returns the word only, no count. */
...
export const skills: Record<string, { name: string; description: string }> = {
  ...
  tough: { name: 'Duro', description: 'El superviviente ignora la primera herida de cada ataque de los zombies y de cada fuego amigo.' },
  sprint: { name: 'Esprintar', description: 'El superviviente puede moverse hasta 3 zonas con 1 acción.' },
  slippery: { name: 'Escurridizo', description: 'El superviviente no gasta acciones extra para salir de una zona con zombies.' },
  ...
  plus_1_to_dice_roll_melee: { name: '+1 a la tirada: cuerpo a cuerpo', description: 'Suma +1 al resultado de cada dado en acciones de cuerpo a cuerpo. El máximo sigue siendo 6.' },
  plus_1_to_dice_roll_combat: { name: '+1 a la tirada: combate', description: 'Suma +1 al resultado de cada dado en cualquier acción de combate. El máximo sigue siendo 6.' },
  roll_6_plus_1_die_combat: { name: 'Saca 6: +1 dado', description: 'Cada 6 en una acción de combate te da un dado más. Seguís tirando mientras sigan saliendo 6.' },
  jump: { name: 'Salto', description: 'Una vez por turno: gastá 1 acción para moverte exactamente 2 zonas, ignorando lo que haya en la zona del medio. Paredes y puertas cerradas siguen frenándote.' },
  shove: { name: 'Empujón', description: 'Una vez por turno, gratis: empujá a todos los zombies de tu zona a una zona a alcance 1 con camino despejado. No es un movimiento.' },
  ...
  plus_1_zone_per_move: { name: '+1 zona por movimiento', description: 'El superviviente puede moverse 1 o 2 zonas con una acción de Moverse. Entrar en una zona con zombies termina el movimiento.' },
  charge: { name: 'Carga', description: 'Una vez por turno, gratis: moverse hasta 2 zonas hacia una zona con al menos 1 zombie.' },
  hit_and_run: { name: 'Golpear y correr', description: 'Tras un ataque que elimina al menos 1 zombie: acción de Moverse gratuita, sin acciones extra por zombies en la zona.' },
  ...
  barbarian: { name: 'Bárbaro', description: 'En un ataque cuerpo a cuerpo, puede reemplazar los dados del arma por la cantidad de zombies en la zona.' },
  ...
  reaper_combat: { name: 'Segador: combate', description: 'Cada impacto puede eliminar gratis 1 zombie idéntico más. Gana XP por la eliminación extra.' },
  reaper_melee: { name: 'Segador: cuerpo a cuerpo', description: 'Cada impacto cuerpo a cuerpo puede eliminar gratis 1 zombie idéntico más. Gana XP por la eliminación extra.' },
  ...
  bloodlust_melee: { name: 'Sed de sangre: cuerpo a cuerpo', description: 'Una vez por turno: gasta 1 acción para moverse hasta 2 zonas hacia una zona con al menos 1 zombie y gana 1 acción cuerpo a cuerpo gratuita.' },
  ...
  lifesaver: { name: 'Salvavidas', description: 'Una vez por turno, gratis: elige una zona a alcance 1 con zombies y supervivientes, y trae a su zona a los supervivientes elegidos.' },
  hold_your_nose: { name: 'Tapate la nariz', description: 'Roba una carta de equipo cada vez que se elimina al último zombie de su zona. No es una acción de Buscar.' },
...
export const actions: Record<string, string> = {
  ...
  SELECT_WEAPON: 'Elegir arma inicial',
  ...
  ORGANIZE: 'Organizar',
  ORGANIZE_START: 'Organizar equipo',
  ORGANIZE_END: 'Terminar de organizar',
