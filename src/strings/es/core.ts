...
export const skills: Record<string, { name: string; description: string }> = {
  ...
  tough: { name: 'Duro', description: 'El superviviente ignora la primera herida de cada ataque de los zombis y de cada fuego amigo.' },
  ...
  shove: { name: 'Empujón', description: 'Una vez por turno, gratis: empujá a todos los zombis de tu zona a una zona a alcance 1 con camino despejado. No es un movimiento.' },
