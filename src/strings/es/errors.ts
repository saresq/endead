...
export const errors = {
  ...
  needZombieAtDestination: (skill: string) => `${skill}: en el destino tiene que haber al menos 1 zombie.`,
  ...
  shoveNeedsZombie: 'En tu zona no hay zombies para empujar.',
  lifesaverNeedsZombie: 'En esa zona tiene que haber al menos 1 zombie.',
  ...
  noPendingZombieWounds: 'No hay heridas de zombies pendientes.',
  ...
  searchWithZombies: 'No podés buscar con zombies en la zona.',
  ...
  characterRequired: 'Falta que todos elijan superviviente.',
  unknownWeapon: 'Esa arma no está entre las iniciales.',
  weaponTaken: 'No quedan copias de esa arma inicial.',
  weaponRequired: 'Falta que todos elijan arma.',
