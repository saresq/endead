...
export interface Zone {
  id: ZoneId;
  connectedZones: ZoneId[];
  isBuilding: boolean;
  hasNoise: boolean;
  noiseTokens: number;
  spawnPoint?: boolean;
  exitPoint?: boolean;
  isExit?: boolean; // New: Objective / Exit Point
  searchable: boolean;
  doorOpen: boolean;
}
...
export const initialGameState: GameState = {
  ...
  zones: {
    ...
    'street-start': {
      ...
      noiseTokens: 0,
      searchable: false,
      doorOpen: true, // Always open to street unless building logic
      spawnPoint: false,
    },
    'street-intersection': {
    ...
    'police-reception': {
      ...
      noiseTokens: 0,
      searchable: true,
      doorOpen: false, // Closed Door to street-start
      spawnPoint: false,
    },
    'police-armory': {
      id: 'police-armory',
      ...
      noiseTokens: 0,
      searchable: true,
      doorOpen: true, // Internal doors open by default
      spawnPoint: false,
    },
    ...
    'diner-front': {
      ...
      noiseTokens: 0,
      searchable: true,
      doorOpen: false, // Closed Door to street-south
      spawnPoint: false,
    },
    'diner-kitchen': {
      id: 'diner-kitchen',
      ...
      noiseTokens: 0,
      searchable: true,
      doorOpen: true, // Internal doors open
      spawnPoint: false,
    }
  },
