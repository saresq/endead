...
When a building is opened for the first time, one Zombie card SHALL be drawn per Dark Zone of the building and resolved with the same rules as the Spawn Step: Extra Activation (no effect at Blue), Rush activation, zombie pool limits with extra activation on exhaustion, and Abomination standard/Fest rules. Buildings open at start SHALL still never spawn.
