# Map Playability Specification

## Purpose

Define what makes a map playable, enforce it when a map is saved, surface it to the author while editing, and keep the lobby from offering maps that cannot be played.
