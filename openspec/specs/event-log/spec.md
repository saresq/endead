...
Give players full game history on every layout, grouped by round and player turn in a form that is easy to scan, with an unread indicator so they know when it has moved, and with entries that only carry the feedback their own action produced.
