# inventory-actions Specification

## Purpose
Charge inventory actions the way the rules do: discarding is free at any time, rearranging costs one action however many cards move, and a trade is rejected unless both resulting inventories are legal and the partner is alive.
