...
Offer the full twelve-survivor base-game roster with the health, type and skill tree printed on each ID Card, so that every survivor is playable, every offered skill takes effect, and an unknown character is refused rather than silently substituted.
