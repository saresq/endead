# Weapon Keywords Specification

## Purpose

Give a weapon's declared keywords effect: `sniper` grants the Sniper skill for that attack, `reload` spends the weapon's shot until it is reloaded, and a weapon may be usable in melee as well as at range.
