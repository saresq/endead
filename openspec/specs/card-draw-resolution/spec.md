# card-draw-resolution Specification

## Purpose
Resolve every drawn card the same way wherever it is drawn — a search, an Epic crate, or a Hold your nose kill — so a card is always kept, offered or discarded, an Aaahh!! always spawns a Walker and stops the draw, and no draw can lose a card or overwrite the experience the kill just granted.
