# Zombie Activation Specification

## Purpose

Ensure zombies move and attack only along open paths, never break or open doors, and that every activation trigger (Activation step, Extra Activation cards, Rush, pool exhaustion) resolves through one shared routine.
