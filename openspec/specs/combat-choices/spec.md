# Combat Choices Specification

## Purpose

Surface the choices the rules give an attacker and carry them to the server: free target selection, the Brute-versus-Abomination priority tie, Steady Hand and Barbarian.
