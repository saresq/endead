# Pending Decisions Specification

## Purpose

Block game flow on unresolved zombie wound distribution and "Is That All You've Got?" decisions, route each decision to the right player (host or survivor owner), and keep every player informed of what is being decided while they wait.
