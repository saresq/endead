...
Deal starting equipment the way the rulebook does — at random from the starting set, reproducible from the game seed — and hand the first player token to the survivor who drew the Fire Axe.
