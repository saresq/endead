...
Provide one straight-line Line of Sight and range computation, shared by ranged attacks, Lifesaver, zombie targeting and client target highlighting, so all callers agree on what is visible and how far away it is.
