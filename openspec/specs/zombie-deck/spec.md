# Zombie Deck Specification

## Purpose

Build the spawn deck from the rulebook's card list, keeping each card's per-danger-level detail — including the Rush cards and the Abominations printed at the Blue level.
